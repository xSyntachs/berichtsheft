...
story = [
    ...
    P("Lade <b>download.bat</b> und <b>download.sh</b> herunter."),
    P("<b>Windows.</b> Doppelklicke <b>download.bat</b>. Wenn Windows "
      "nachfragt, bestätige mit Ausführen."),
    P("<b>Mac und Linux.</b> Öffne ein Terminal und führe diese drei Befehle "
      "aus."),
    Preformatted("cd Downloads\nchmod +x download.sh\n./download.sh", code),
    P("Wähle die Version Normal, dafür einfach Enter drücken (die Demo ist nur "
      "zum Testen). Das Programm installiert sich in den Ordner "
      "<b>Berichtsheft-Suite</b> in deinem Benutzerordner und öffnet sich "
      "danach von selbst. Beim ersten Start lädt es einmalig einen Browser "
      "nach, das dauert ein paar Minuten."),

    P("2. Berichtsheft holen", h2),
    P("<b>Weg A, von der IHK-Seite.</b> Führst du dein Heft online bei der IHK, "
      "wähle im Programm den Punkt <b>download</b>. Es fragt deine IHK-E-Mail, "
      "dein IHK-Passwort (die Eingabe bleibt unsichtbar) und die Stadt deiner "
      "IHK. Danach öffnet sich ein Browser, der alles von allein einsammelt. "
      "Nur warten, nichts anklicken. Dein Passwort wird nirgends gespeichert."),
    P("<b>Weg B, aus einer Word-Datei.</b> Führst du dein Heft in Word, lege die "
      "Word-Datei in den Ordner Berichtsheft-Suite (den hat Schritt 1 angelegt) "
      "und wähle im Programm den Punkt <b>word</b>. Die Datei muss so aussehen. "
      "Jede Woche beginnt mit "
      "einer Zeile, in der das Wort Ausbildungswoche und der Zeitraum stehen, "
    ...
    P("Zeilen, die mit Berufsschule oder Lernfeld beginnen, landen automatisch "
      "bei der Schule, alle anderen beim Betrieb. Stunden musst du nicht "
      "angeben, es werden 8 pro Tag eingetragen."),

    P("3. In apprentio eintragen", h2),
    P("Im Programm den Punkt <b>upload</b> wählen. Beim ersten Mal fragt es die "
      "apprentio-Adresse deiner Firma, der Name vor dem Punkt genügt, bei "
      "xsyntachs.apprentio.de also nur xsyntachs. Dann E-Mail und Passwort "
      "deines eigenen apprentio-Zugangs. Das Programm trägt alle Tätigkeiten in "
      "den richtigen Wochen ein und fragt am Ende, ob es die Wochen beim Prüfer "
      "einreichen soll."),
